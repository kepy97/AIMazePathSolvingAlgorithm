...
class BGA():
    ...
    """
    def __init__(self, pop_shape, method, GAcost, GAreach, GAbudget, p_c=0.8, p_m=0.2, max_round = 1000, early_stop_rounds=None, verbose = None, maximum=True):
        """
        Args:
    ...
    def evaluation(self, pop):
        ...
        """
        return np.array([self.method(i, self.cost, self.reach, self.budget) for i in pop])
